# code from here: https://github.com/bvnayak/stereo_calibration
import numpy as np
import cv2
import glob
import argparse
...
class StereoCalibration(object):
    ...
    def stereo_calibrate(self, dims):
        ...
        for key, value in camera_model.items():
            if key == 'rvecs2' or key == 'rvecs1':
                continue
            out[key] = value.tolist()
        with open("stereo_intrinsics.json", "w") as outfile:
