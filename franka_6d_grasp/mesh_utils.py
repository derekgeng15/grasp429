...
class PandaGripper(object):
    ...
    def __init__(self, q=None, num_contact_points_per_finger=10, root_folder=os.path.dirname(os.path.dirname(os.path.abspath(__file__)))):
        ...
        self.q = q
        fn_base = os.path.join('/home/robotdev/franka_dev/franka_6d_grasp/gripper_models/panda_gripper/hand.stl')
        fn_finger = os.path.join('/home/robotdev/franka_dev/franka_6d_grasp/gripper_models/panda_gripper/finger.stl')
        ...
        with open(os.path.join('/home/robotdev/franka_dev/franka_6d_grasp/gripper_control_points/panda_gripper_coords.pickle'), 'rb') as f:
    ...
    def get_control_point_tensor(self, batch_size, use_tf=True, symmetric = False, convex_hull=True):
        ...
        control_points = np.load(os.path.join('/home/robotdev/franka_dev/franka_6d_grasp/gripper_control_points/panda.npy'))[:, :3]
        if symmetric:
